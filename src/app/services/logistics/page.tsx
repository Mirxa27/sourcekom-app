      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Transform your logistics operations with our comprehensive supply chain solutions designed for the Saudi Arabian market.
          </p>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Our logistics and supply chain management services help businesses optimize their operations, reduce costs, and improve efficiency across the entire supply chain.
                </CardDescription>
              </CardHeader>
