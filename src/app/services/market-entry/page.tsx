    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Successfully enter and expand within Saudi Arabian market with our expert guidance and local connections.
        </p>
      </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Navigate complexities of entering Saudi market with our comprehensive market entry services.
              </CardDescription>
            </CardHeader>
